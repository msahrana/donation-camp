...
const DonationCard = ({card}) => {
    ...
    const {image, title, price, category, text_color, category_bg} = card || {}
    return (
        <div>
  ...
  <div className="p-6">
    <h6 className="mb-4 block font-sans text-base font-semibold uppercase leading-relaxed tracking-normal text-pink-500 antialiased" style={{color: text_color, backgroundColor: category_bg}}>
      {category}
    </h6>
